...
description: |
    Bioinformatician developing and maintaining open source software
aliases:
    - about.html
...
about:
  ...
  links:
    ...
    - icon: mastodon
      ...
      rel: me
    - text: "{{< fa solid square >}}" # https://github.com/FortAwesome/Font-Awesome/issues/19810
      href: https://bsky.app/profile/kelly-sovacool.bsky.social
    - icon: linkedin
