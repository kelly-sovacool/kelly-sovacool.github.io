...
description: | 
    Bioinformatician building and applying open source tools for microbiome
    research, and contributing to data science education along the way
aliases:
    - about.html
...
about:
  ...
  links:
    ...
    - icon: envelope
      href: mailto:sovacool@umich.edu
    - icon: mastodon
